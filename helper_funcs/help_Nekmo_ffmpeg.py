...
async def place_water_mark(input_file, output_file, water_mark_file):
    ...
    commands_to_execute = [
        ...
        # "-vf \"drawtext=text='@KR_ROCKERS_DVD_WEB_OTT_MOVIES':x=W-(W/2):y=H-(H/2):fontfile=" + Config.FONT_FILE + ":fontsize=12:fontcolor=white:shadowcolor=black:shadowx=5:shadowy=5\"",
        output_file
    ]
