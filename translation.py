class Translation(object):
    START_TEXT = """ <b> Hi {} , I'm KR RENAME BOT And I well Use A Simple File Renamer+File To Video Converter Bot With Permanent Thumbnail support!💯</b> \n

<b>CREATE By: @KicchaRequest </b> \n 
"""

    RENAME_403_ERR = "What Are You Doing? Bruuh!!"
    BANNED_USER_TEXT = "Sorry!! But Mai Owner As Banned You From Using This Service. That Means You Can't Run Meh Now! \n \n Contact : @sachin_official_admin For more Details.. " 
    ABS_TEXT = "What Are You Trying To Do,Mate?"
    UPGRADE_TEXT = "CONTACT @sachin_official_admin "
    DOWNLOAD_START = "<b>Downloading To My Database server ⛕ pls Wait</b>"
    UPLOAD_START = "<b>Downloading Completed Now I'm Uploading Into TG</b>"
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry Do You Think! I'll Upload It?"
    AFTER_SUCCESSFUL_UPLOAD_MSG = "<b>Thank you for Using Me Support Our Channel @KicchaRequest</b>"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds"
    NOT_AUTH_USER_TEXT = "CONTACT @sachin_official_admin "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @sachin_official_admin "
